    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterventionHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InterventionHistory_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PiecesRechange_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reclamations_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Interventions_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "InterventionPieceRechange",
                columns: table => new
                {
                    InterventionsId = table.Column<int>(type: "int", nullable: false),
                    PiecesRechangeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterventionPieceRechange", x => new { x.InterventionsId, x.PiecesRechangeId });
                    table.ForeignKey(
                        name: "FK_InterventionPieceRechange_Interventions_InterventionsId",
                        column: x => x.InterventionsId,
                        principalTable: "Interventions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InterventionPieceRechange_PiecesRechange_PiecesRechangeId",
                        column: x => x.PiecesRechangeId,
                        principalTable: "PiecesRechange",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterventionHistory_ApplicationUserId",
                table: "InterventionHistory",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_InterventionPieceRechange_PiecesRechangeId",
                table: "InterventionPieceRechange",
                column: "PiecesRechangeId");

            migrationBuilder.CreateIndex(
                name: "IX_Interventions_ApplicationUserId",
                table: "Interventions",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PiecesRechange_ApplicationUserId",
                table: "PiecesRechange",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Reclamations_ApplicationUserId",
                table: "Reclamations",
                column: "ApplicationUserId");
